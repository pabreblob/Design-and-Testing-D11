...
<display:table class="displaytag" name="advertisements" id="row" requestURI="advertisement/admin/list.do" pagesize="5">
	...
	<display:column><a href="advertisement/admin/delete.do?advertisementId=${row.id}"><spring:message code="advertisement.delete"/></a></display:column>
